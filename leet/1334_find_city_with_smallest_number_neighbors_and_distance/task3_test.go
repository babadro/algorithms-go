...
func TestFindTheCity(t *testing.T) {
	cases := []struct {
		...
		{4,
			[][3]int{{0, 1, 3}, {1, 2, 1}, {1, 3, 4}, {2, 3, 1}},
			4,
			3,
		},
		{5,
			[][3]int{{0, 1, 2}, {0, 4, 8}, {1, 2, 3}, {1, 4, 2}, {2, 3, 1}, {3, 4, 1}},
			2,
			0,
		},
		{2,
	...
	for i, c := range cases {
		if fact := findTheCity(c.n, c.edges, c.threshold); fact != c.expected {

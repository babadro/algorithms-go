...
func Test_kthSmallest(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "1", args: args{[]int{3, 1, 4, binaryTree.Null, 2}, 1}, want: 1},
		{name: "2", args: args{[]int{5, 3, 6, 2, 4, binaryTree.Null, binaryTree.Null, 1}, 3}, want: 3},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			root := binaryTree.ArrayToBinaryTree(tt.args.arr)
